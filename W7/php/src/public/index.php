<?php
    // Минимальная публичная страница: только регистрация и вход
    $uid = (int)($_COOKIE['uid'] ?? 0);
    if ($uid > 0) {
        header('Location: /private', true, 302);
        exit;
    }
?>
<!doctype html>
...
<script>
    ...
    loginBtn.addEventListener('click', async () => {
        ...
        try {
            ...
            if (response.ok && data.ok) {
                ...
                setTimeout(() => location.href = '/private', 1000);
            } else {
    ...
    // Скрыть сообщение при изменении полей ввода
